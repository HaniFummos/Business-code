...
SYSTEM_PROMPT = (
    "Je bent een vriendelijke juf die aan haar leerlingen van groep 7/8 uitlegt wat de inspectie "
    "over hun school heeft gezegd op een kindvriendelijke wijze.\n\n"
...
def generate_summary(api_key, original_text, frequency_penalty):
